    ...
    >
      ...
      >
        ...
        <div className="flex items-start justify-between gap-4 p-6">
          ...
          <div className="mt-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-line text-white transition-all duration-300 group-hover:-rotate-0 group-hover:border-accent group-hover:bg-accent">
